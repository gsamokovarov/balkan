# lib/generators/admin/scaffold_generator.rb
...
module Admin
  class ScaffoldGenerator < Rails::Generators::Base
    ...
    def create_controller
      ...
      template "controller.rb", "app/controllers/admin/#{@resource_plural}_controller.rb"
    end

    def create_views
      %w[index new show].each do |view|
        template "views/#{view}.html.erb", "app/views/admin/#{@resource_plural}/#{view}.html.erb"
      end

      template "views/_form.html.erb", "app/views/admin/#{@resource_plural}/_form.html.erb"
      template "views/_resources.html.erb", "app/views/admin/#{@resource_plural}/_#{@resource_plural}.html.erb"
    end
