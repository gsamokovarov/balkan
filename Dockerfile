...
RUN SECRET_KEY_BASE_DUMMY=1 SETTINGS_FORCE_OPTIONAL=1 ./bin/rails assets:precompile
...
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y curl libsqlite3-0 libvips librsvg2-2 && \
