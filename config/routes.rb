Rails.application.routes.draw do
  ...
  namespace :admin do
    ...
    resources :events, only: [:index, :show, :new, :create, :edit, :update] do
      ...
      resource :event_activity, only: [:show, :create, :update]
      ...
      resources :contracts, only: [:index, :show, :new, :create, :update, :destroy] do
        member do
          get :download
        end
      end
      ...
      resources :communication_drafts, only: [:index, :show, :new, :create, :update, :destroy] do
        collection do
          post :preview
        end
      end
